...
* `ProductTag`
  ...
  * `tag_id`
    ...
    * References the `Tag` model's `id`.
    ...
    Then I connected them through the proper associations in the index model file with their respective foreign key relationships.
    Route methods for respective api routes were completed and then run through insomnia to check status.
